...
// ---------
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// key
		ourShader.setVec3("pointLights[0].position", glm::vec3(0.0f, 1.5f, -0.5f));
		...
		// point light 2
		ourShader.setVec3("pointLights[1].position", glm::vec3(0.0f, -1.0f, 0.5f));
		ourShader.setVec3("pointLights[1].ambient", 0.5f, 0.05f, 0.05f);
		ourShader.setVec3("pointLights[1].diffuse", 0.4f, 0.4f, 0.4f);
		ourShader.setVec3("pointLights[1].specular", 1.0f, 1.0f, 1.0f);
		ourShader.setFloat("pointLights[1].constant", 1.0f);
		ourShader.setFloat("pointLights[1].linear", 0.09);
		ourShader.setFloat("pointLights[1].quadratic", 0.032);
		// I have no idea how to get rid of these extra point lights so I set them all to zero
		ourShader.setVec3("pointLights[2].position", glm::vec3(0.1f, 3.0f, 0.2f));
		ourShader.setVec3("pointLights[2].ambient", 0.0f, 0.0f, 0.0f);
		ourShader.setVec3("pointLights[2].diffuse", 0.f, 0.f, 0.f);
		ourShader.setVec3("pointLights[2].specular", 0.0f, 0.0f, 0.0f);
		ourShader.setFloat("pointLights[2].constant", 1.0f);
		ourShader.setFloat("pointLights[2].linear", 0.09);
		ourShader.setFloat("pointLights[2].quadratic", 0.032);
		// point light 4
		ourShader.setVec3("pointLights[3].position", glm::vec3(1.0f, 3.0f, 0.f));
		ourShader.setVec3("pointLights[3].ambient", 0.0f, 0.0f, 0.0f);
		ourShader.setVec3("pointLights[3].diffuse", 0.f, 0.f, 0.f);
